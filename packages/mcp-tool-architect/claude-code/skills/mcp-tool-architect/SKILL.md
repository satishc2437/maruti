...
description: Use when the user wants to design a new MCP tool from a problem statement. Conducts a focused requirements interview and emits decision-ready specs (requirements, engineering guardrails, success criteria) under mcp-tools/<tool>/specs/product-docs/.
---
